...
streamlit.dataframe(my_fruit_list)#After pulling the data into a pandas dataframe called my_fruit_list, we will ask the streamlit library to display it on the page
